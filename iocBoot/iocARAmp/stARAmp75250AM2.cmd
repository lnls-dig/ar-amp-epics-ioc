...
dbLoadRecords("${TOP}/db/ARAmp75250AM2.db", "P=$(P), R=$(R), PORT=AMPPORT")
...
create_monitor_set("auto_settings_ARAmp75250AM2.req", 5, "P=${P}, R=${R}")
set_savefile_name("auto_settings_ARAmp75250AM2.req", "auto_settings_${P}${R}.sav")
